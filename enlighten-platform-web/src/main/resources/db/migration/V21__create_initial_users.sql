...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin03', MD5('123456'), 'admin_g_x_01@gzrmyy.com', '13800000003', 1, 'USER', '赣州人民医院', '宣传科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_G_X_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin04', MD5('123456'), 'admin_g_x_02@gzrmyy.com', '13800000004', 1, 'USER', '赣州人民医院', '宣传科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin05', MD5('123456'), 'admin_g_i_01@gzrmyy.com', '13800000005', 1, 'USER', '赣州人民医院', '信息科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_G_I_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin06', MD5('123456'), 'admin_g_i_02@gzrmyy.com', '13800000006', 1, 'USER', '赣州人民医院', '信息科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin07', MD5('123456'), 'admin_g_z_01@gzrmyy.com', '13800000007', 1, 'USER', '赣州人民医院', '肿瘤科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_G_Z_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin08', MD5('123456'), 'admin_g_z_02@gzrmyy.com', '13800000008', 1, 'USER', '赣州人民医院', '肿瘤科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin09', MD5('123456'), 'admin_o_f_01@other.com', '13800000009', 1, 'USER', '其他医院', '妇科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_O_F_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin10', MD5('123456'), 'admin_o_f_02@other.com', '13800000010', 1, 'USER', '其他医院', '妇科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin11', MD5('123456'), 'admin_o_x_01@other.com', '13800000011', 1, 'USER', '其他医院', '宣传科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_O_X_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin12', MD5('123456'), 'admin_o_x_02@other.com', '13800000012', 1, 'USER', '其他医院', '宣传科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin13', MD5('123456'), 'admin_o_i_01@other.com', '13800000013', 1, 'USER', '其他医院', '信息科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_O_I_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin14', MD5('123456'), 'admin_o_i_02@other.com', '13800000014', 1, 'USER', '其他医院', '信息科'
) AS tmp
...
INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin15', MD5('123456'), 'admin_o_z_01@other.com', '13800000015', 1, 'USER', '其他医院', '肿瘤科'
) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM `user` WHERE `username` = 'admin_O_Z_01');

INSERT INTO `user` (`username`, `password`, `email`, `phone`, `status`, `role`, `hospital`, `department`)
SELECT * FROM (
    SELECT 'admin16', MD5('123456'), 'admin_o_z_02@other.com', '13800000016', 1, 'USER', '其他医院', '肿瘤科'
) AS tmp
